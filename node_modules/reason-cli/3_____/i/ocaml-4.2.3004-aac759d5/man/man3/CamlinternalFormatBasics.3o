.TH "CamlinternalFormatBasics" 3 2018-08-20 OCamldoc "OCaml library"
.SH NAME
...
.B -> 
.B (('b15 -> 'x6 -> 'c15) -> 'x6 -> 'a15, 'b15, 'c15, 'd15, 'e15, 'f15)
.B   fmt
 | Theta
.B : 
...
.B -> 
.B ('x7 -> 'a19, 'b19, 'c19, ('b19 -> 'x7) -> 'd19, 'e19, 'f19)
.B   fmt
 | Scan_char_set
.B : 
...
.B (char -> 'a22, 'b22, 'c22, 'd22, 'e23, 'f23) fmt
 | Ignored_param
.B : 
.B ('a23, 'b23, 'c23, 'd23, 'y4, 'x8) ignored
.B    * ('x8, 'b23, 'c23, 'y4, 'e24, 'f24) fmt
.B -> 
.B ('a23, 'b23, 'c23, 'd23, 'e24, 'f24) fmt
 | Custom
.B : 
.B ('a24, 'x9, 'y5) custom_arity * (unit -> 'x9)
