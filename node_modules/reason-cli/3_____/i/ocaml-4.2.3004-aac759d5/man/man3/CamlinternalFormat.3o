.TH "CamlinternalFormat" 3 2018-08-20 OCamldoc "OCaml library"
.SH NAME
...
.B   (Pervasives.out_channel, unit) acc -> unit
.sp
...
.I val string_of_formatting_gen 
: 
.B ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics.formatting_gen -> string
.sp
