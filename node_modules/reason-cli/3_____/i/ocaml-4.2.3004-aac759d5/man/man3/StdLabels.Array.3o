.TH "StdLabels.Array" 3 2018-08-20 OCamldoc "OCaml library"
.SH NAME
...
.B ArrayLabels\&.make_matrix dimx dimy e
...
.B len < 0
, or 
.B start + len > ArrayLabels\&.length a
\&.
...
.B ArrayLabels\&.fill a ofs len x
modifies the array 
.B a
in place,
storing 
...
.B ArrayLabels\&.blit v1 o1 v2 o2 len
copies 
.B len
elements
from array 
...
.B a
\&.  It is equivalent to
.B f a\&.(0); f a\&.(1); \&.\&.\&.; f a\&.(ArrayLabels\&.length a \- 1); ()
\&.
...
.B ArrayLabels\&.fold_right f a x
computes
