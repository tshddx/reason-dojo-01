.TH "Parsetree" 3 2018-08-20 OCamldoc "OCaml library"
.SH NAME
...
.B string
 | Ptyp_arrow
.B of 
.B Asttypes.label * core_type * core_type
 | Ptyp_tuple
.B of 
.B core_type list
 | Ptyp_constr
...
.B Longident.t Asttypes.loc * core_type list
 | Ptyp_object
.B of 
.B (string * attributes * core_type) list
.B    * Asttypes.closed_flag
 | Ptyp_class
.B of 
.B Longident.t Asttypes.loc * core_type list
 | Ptyp_alias
...
=
 | Rtag
.B of 
.B Asttypes.label * attributes * bool * core_type list
 | Rinherit
.B of 
.B core_type
...
.B Asttypes.constant
 | Ppat_interval
.B of 
.B Asttypes.constant * Asttypes.constant
 | Ppat_tuple
.B of 
.B pattern list
 | Ppat_construct
...
.B case list
 | Pexp_fun
.B of 
.B Asttypes.label * expression option * pattern
.B    * expression
 | Pexp_apply
.B of 
.B expression * (Asttypes.label * expression) list
 | Pexp_match
.B of 
...
.B string Asttypes.loc * expression
 | Pexp_override
.B of 
.B (string Asttypes.loc * expression) list
 | Pexp_letmodule
.B of 
...
=
 | Pext_decl
.B of 
.B core_type list * core_type option
 | Pext_rebind
.B of 
.B Longident.t Asttypes.loc
...
.B class_signature
 | Pcty_arrow
.B of 
.B Asttypes.label * core_type * class_type
 | Pcty_extension
.B of 
.B extension
...
.B class_type
 | Pctf_val
.B of 
.B (string * Asttypes.mutable_flag * Asttypes.virtual_flag * core_type)
 | Pctf_method
.B of 
.B (string * Asttypes.private_flag * Asttypes.virtual_flag * core_type)
 | Pctf_constraint
.B of 
...
.B    * class_expr
 | Pcl_apply
.B of 
.B class_expr * (Asttypes.label * expression) list
 | Pcl_let
.B of 
...
=
 | Pcf_inherit
.B of 
.B Asttypes.override_flag * class_expr * string option
 | Pcf_val
.B of 
.B (string Asttypes.loc * Asttypes.mutable_flag * class_field_kind)
 | Pcf_method
.B of 
.B (string Asttypes.loc * Asttypes.private_flag * class_field_kind)
 | Pcf_constraint
.B of 
.B (core_type * core_type)
 | Pcf_initializer
...
.B type_declaration
 | Pwith_modsubst
.B of 
.B string Asttypes.loc * Longident.t Asttypes.loc
