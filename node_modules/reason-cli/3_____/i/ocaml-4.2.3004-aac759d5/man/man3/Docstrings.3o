.TH "Docstrings" 3 2018-08-20 OCamldoc "OCaml library"
.SH NAME
...
.B 
.B 
.B    These functions are used by the lexer to associate docstrings to
.B    the locations of tokens\&. ===
...
.B 
.B 
.B     The Docstrings\&.docs type represents documentation attached to an item\&. ===
...
.B === 
.B Fields and constructors
.B 
.B 
.B     The Docstrings\&.info type represents documentation attached to a field or
.B     constructor\&. ===
...
.B === 
.B Unattached comments
.B 
.B 
.B     The Docstrings\&.text type represents documentation which is not attached to
.B     anything\&. ===
...
.B 
.B 
.B     There may be additional text attached to the delimiters of a block
.B     (e\&.g\&. struct and end)\&. This is fetched by the following
.B     functions, which are applied to the contents of the block rather
.B     than the delimiters\&. ===
