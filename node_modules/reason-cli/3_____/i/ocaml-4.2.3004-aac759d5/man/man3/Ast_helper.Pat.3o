.TH "Ast_helper.Pat" 3 2018-08-20 OCamldoc "OCaml library"
.SH NAME
...
: 
.B ?loc:Ast_helper.loc ->
.B   ?attrs:Ast_helper.attrs -> Asttypes.constant -> Parsetree.pattern
.sp
...
.B ?loc:Ast_helper.loc ->
.B   ?attrs:Ast_helper.attrs ->
.B   Asttypes.constant -> Asttypes.constant -> Parsetree.pattern
.sp
...
.B ?loc:Ast_helper.loc ->
.B   ?attrs:Ast_helper.attrs ->
.B   Ast_helper.lid -> Parsetree.pattern option -> Parsetree.pattern
.sp
